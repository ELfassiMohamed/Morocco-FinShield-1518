...
Kantara is a fast, local-first document preprocessor designed to extract and optimize data from various file formats (PDF, DOCX, PPTX, CSV) for Large Language Models (LLMs). It converts complex documents into token-efficient JSON or Markdown formats.
...
- **Extraction:** Apache POI (DOCX/PPTX/CSV support) and PDFBox (PDF).
